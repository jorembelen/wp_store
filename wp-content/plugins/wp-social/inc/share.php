...
Class Share{
	...
	*/
	...
	public function get_share_data($provider = 'all', $config = []){
		...
		$style = get_option( 'xs_style_setting_data_share' , '');
		$styleConfig = isset($style['login_button_style']) ? $style['login_button_style'] :  'floating';
	...
	public function social_counter_url(){
		...
		//$link['facebook'] = [ 'url' => 'https://graph.facebook.com/vX.X/?id=http%3A%2F%2Fwww.imdb.com%2Ftitle%2Ftt2015381%2F&fields=engagement&access_token=user-access-token', 'params' => [] ];
