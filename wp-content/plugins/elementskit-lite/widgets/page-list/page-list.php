...
class Elementskit_Widget_Page_List extends Widget_Base {
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'ekit_href_target',
			[
				'label' => __( 'Target', 'elementskit' ),
				'type' => Controls_Manager::SELECT,
				'default' => '_blank',
				'options' => [
					'_blank'  => __( 'Blank', 'elementskit' ),
					'self' => __( 'Self', 'elementskit' ),
				],
			]
		);
		...
		$repeater->add_control(
			...
			[
				'label' => __( 'Sub Title', 'elementskit' ),
				'type' => Controls_Manager::TEXT,
				'label_block' => true,
		...
		$repeater->add_control(
			...
			[
				'label' => __( 'Show Icon', 'elementskit' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => __( 'Show', 'elementskit' ),
				'label_off' => __( 'Hide', 'elementskit' ),
				'return_value' => 'yes',
		...
		$repeater->add_control(
			...
			[
				'label' => __( 'Show Label', 'elementskit' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => __( 'Show', 'elementskit' ),
				'label_off' => __( 'Hide', 'elementskit' ),
				'return_value' => 'yes',
		...
		$repeater->add_control(
			...
			[
				...
				'type' => Controls_Manager::TEXT,
				'default' => __( 'Default title', 'elementskit' ),
				'placeholder' => __( 'Type your title here', 'elementskit' ),
				'dynamic' => [
					'active' => true,
				],
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __( 'Background Hover', 'elementskit' ),
				'types' => [ 'classic', 'gradient' ],
		...
		$this->add_control(
			...
			[
				'label' => __( 'Color Hover', 'elementskit' ),
				'type' => Controls_Manager::COLOR,
				'scheme' => [
					'type' => Scheme_Color::get_type(),
					'value' => Scheme_Color::COLOR_1,
