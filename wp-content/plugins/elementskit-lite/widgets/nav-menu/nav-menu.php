...
class Elementskit_Widget_Nav_Menu extends Widget_Base {
    ...
    protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				'label' => __( 'Choose Mobile Menu Logo', 'elementskit' ),
		...
		$this->add_control(
			...
			[
				...
				'default' => 'home',
				'options' => [
					'home' => __( 'Home', 'elementskit' ),
					'custom' => __( 'Custom URL', 'elementskit' ),
				],
			]
		);
        ...
        $this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .ekit-wid-con' => 'min-height: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .elementskit-navbar-nav > li > a i' => 'color: {{VALUE}}',
				],
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Mobile Menu Logo', 'elementskit' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
    ...
    protected function render_raw( ) {
		...
		if($settings['elementskit_nav_menu'] != ''){
			$link = '';
